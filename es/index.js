...
var components = [AcIcon, AcButton, AcButtonGroup, AcInput, AcSwiper, AcCarousel, AcCart, AcContainer, AcHeader, AcMain, AcFooter, AcTabbar, AcTabbarItem, AcCircle, AcModal, AcInputNumber, AcCell, AcPopup, AcGroup, AcProgress, AcXcheckbox, AcXswitch, Card, CardItem, CardPrefix, CardBody, AcCollaspe, AcCollaspeItem, Radio, RadioGroup, RadioButton];
/**
 * 添加 install 方法
 * @param {*} Vue
 */
...
export { install, AcIcon, AcButton, AcButtonGroup, AcInput, AcSwiper, AcCarousel, AcCart, AcContainer, AcHeader, AcMain, AcFooter, AcTabbar, AcTabbarItem, AcCircle, AcModal, AcInputNumber, AcGroup, AcPopup, AcCell, AcProgress, AcXcheckbox, AcXswitch, AcCollaspe, AcCollaspeItem, Card, CardItem, CardPrefix, CardBody, Radio, RadioGroup, RadioButton };